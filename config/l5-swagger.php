...
return [
    ...
    'documentations' => [
        'default' => [
            ...
            'paths' => [
                ...
                'docs' => storage_path('api-docs/api-docs.yaml'),
                'annotations' => [
    ...
    'defaults' => [
        ...
        'paths' => [
            ...
            'base' => env('L5_SWAGGER_BASE_PATH', 'http://localhost:85/api'),
            'excludes' => [],
        ],
        'scanOptions' => [
        ...
        'constants' => [
            'L5_SWAGGER_CONST_HOST' => env('L5_SWAGGER_CONST_HOST', 'http://localhost:85'),
        ],
    ],
];
